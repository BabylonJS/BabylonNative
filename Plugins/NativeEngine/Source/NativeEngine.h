...
namespace Babylon
{
    ...
    public:
        ...
        NativeEngine(const Napi::CallbackInfo& info, Polyfills::Internal::NativeWindow& nativeWindow);
        ~NativeEngine();
    ...
    private:
        ...
        Polyfills::Internal::NativeWindow::NativeWindow::OnResizeCallbackTicket m_resizeCallbackTicket;
