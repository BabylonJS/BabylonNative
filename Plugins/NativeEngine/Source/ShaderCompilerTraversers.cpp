...
namespace Babylon::ShaderCompilerTraversers
{
    ...
    namespace
    {
        ...
        /// </summary>
        /// <param name="nameToReplacement">Map from symbol names to the node which should replace that symbol.</param>
        /// <param name="symbolToParent">Vector of symbols to be replaced along with their parents in the AST.</param>
        ...
        /// </summary>
        /// <param name="path">The path to the element in question.</param>
        /// <returns>True if path is for a linker object, false otherwise.</returns>
        ...
        public:
            ...
            ~NonSamplerUniformToStructTraverser() override
            {
            }
