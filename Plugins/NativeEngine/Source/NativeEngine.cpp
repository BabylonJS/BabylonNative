    ...
    void NativeEngine::Initialize(Napi::Env env)
    {
        ...
        Napi::Function func = DefineClass(
            ...
            JS_CLASS_NAME,
            {
                ...
                StaticValue("COMMAND_DRAWINDEXED_INSTANCED", Napi::FunctionPointer::Create(env, &NativeEngine::DrawIndexedInstanced)),
                StaticValue("COMMAND_DRAW", Napi::FunctionPointer::Create(env, &NativeEngine::Draw)),
                StaticValue("COMMAND_DRAW_INSTANCED", Napi::FunctionPointer::Create(env, &NativeEngine::DrawInstanced)),
