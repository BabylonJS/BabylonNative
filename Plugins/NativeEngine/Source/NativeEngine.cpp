    ...
    void NativeEngine::Initialize(Napi::Env env)
    {
        ...
        Napi::Function func = DefineClass(
            ...
            JS_CLASS_NAME,
            {
                ...
                StaticValue("CAPS_LIMITS_MAX_DRAW_CALLS", Napi::Number::From(env, limits.maxDrawCalls)),
                StaticValue("CAPS_LIMITS_MAX_BLITS", Napi::Number::From(env, limits.maxBlits)),
                ...
                StaticValue("CAPS_LIMITS_MAX_VIEWS", Napi::Number::From(env, limits.maxViews)),
                StaticValue("CAPS_LIMITS_MAX_FRAME_BUFFERS", Napi::Number::From(env, limits.maxFrameBuffers)),
                StaticValue("CAPS_LIMITS_MAX_FB_ATTACHMENTS", Napi::Number::From(env, limits.maxFBAttachments)),
                StaticValue("CAPS_LIMITS_MAX_PROGRAMS", Napi::Number::From(env, limits.maxPrograms)),
                StaticValue("CAPS_LIMITS_MAX_SHADERS", Napi::Number::From(env, limits.maxShaders)),
                StaticValue("CAPS_LIMITS_MAX_TEXTURES", Napi::Number::From(env, limits.maxTextures)),
                StaticValue("CAPS_LIMITS_MAX_TEXTURE_SAMPLERS", Napi::Number::From(env, limits.maxTextureSamplers)),
                StaticValue("CAPS_LIMITS_MAX_COMPUTE_BINDINGS", Napi::Number::From(env, limits.maxComputeBindings)),
                StaticValue("CAPS_LIMITS_MAX_VERTEX_LAYOUTS", Napi::Number::From(env, limits.maxVertexLayouts)),
                StaticValue("CAPS_LIMITS_MAX_VERTEX_STREAMS", Napi::Number::From(env, limits.maxVertexStreams)),
                StaticValue("CAPS_LIMITS_MAX_INDEX_BUFFERS", Napi::Number::From(env, limits.maxIndexBuffers)),
                StaticValue("CAPS_LIMITS_MAX_VERTEX_BUFFERS", Napi::Number::From(env, limits.maxVertexBuffers)),
                StaticValue("CAPS_LIMITS_MAX_DYNAMIC_INDEX_BUFFERS", Napi::Number::From(env, limits.maxDynamicIndexBuffers)),
                StaticValue("CAPS_LIMITS_MAX_DYNAMIC_VERTEX_BUFFERS", Napi::Number::From(env, limits.maxDynamicVertexBuffers)),
                StaticValue("CAPS_LIMITS_MAX_UNIFORMS", Napi::Number::From(env, limits.maxUniforms)),
                StaticValue("CAPS_LIMITS_MAX_OCCLUSION_QUERIES", Napi::Number::From(env, limits.maxOcclusionQueries)),
                StaticValue("CAPS_LIMITS_MAX_ENCODERS", Napi::Number::From(env, limits.maxEncoders)),
                StaticValue("CAPS_LIMITS_MIN_RESOURCE_CB_SIZE", Napi::Number::From(env, limits.minResourceCbSize)),
                StaticValue("CAPS_LIMITS_TRANSIENT_VB_SIZE", Napi::Number::From(env, limits.transientVbSize)),
                StaticValue("CAPS_LIMITS_TRANSIENT_IB_SIZE", Napi::Number::From(env, limits.transientIbSize)),
