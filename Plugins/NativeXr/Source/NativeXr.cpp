...
namespace Babylon
{
    ...
    arcana::task<void, std::exception_ptr> NativeXr::BeginSession(Napi::Env /*env*/)
    {
        ...
        return xr::System::Session::CreateAsync(m_system, bgfx::getInternalData()->context, bgfx::g_platformData.nwh).then(arcana::inline_scheduler, m_cancellationSource, [this](std::shared_ptr<xr::System::Session> session) {
