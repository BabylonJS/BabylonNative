...
/**
 * JVM binding for the C++ Babylon::Integrations layer. Native methods
 * mirror byte-for-byte the {@code extern "C" JNIEXPORT} entry points in
 * {@code Integrations/Android/src/main/cpp/BabylonNativeIntegrations.cpp}.
 *
...
public final class BabylonNative {
     ...
     * {@code Babylon::Integrations::RuntimeOptions}. Fields are public for
