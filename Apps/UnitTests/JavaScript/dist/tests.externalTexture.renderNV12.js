...
"use strict";
/*!*************************************************!*\
  !*** ./src/tests.externalTexture.renderNV12.ts ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
...
height)
{
  ...
  var yInternal = engine.wrapNativeTexture(yNativeTexture);
  var yWrapper = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Texture(null, scene);
  yWrapper._texture = yInternal;
  yWrapper.updateSamplingMode(_babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Constants.TEXTURE_NEAREST_SAMPLINGMODE);
  material.setTexture("yTextureSampler", yWrapper);

  var uvInternal = engine.wrapNativeTexture(uvNativeTexture);
  var uvWrapper = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Texture(null, scene);
  uvWrapper._texture = uvInternal;
  uvWrapper.updateSamplingMode(_babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Constants.TEXTURE_NEAREST_SAMPLINGMODE);
  material.setTexture("uvTextureSampler", uvWrapper);

  quad.material = material;
}function

render() {return _render.apply(this, arguments);}function _render() {_render = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {while (1) switch (_context.prev = _context.next) {case 0:_context.next = 1;return (
            scene.whenReadyAsync());case 1:
          scene.render();case 2:case "end":return _context.stop();}}, _callee);}));return _render.apply(this, arguments);}
