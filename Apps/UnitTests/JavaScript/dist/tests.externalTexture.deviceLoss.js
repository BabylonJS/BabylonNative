...
"use strict";
/*!*************************************************!*\
  !*** ./src/tests.externalTexture.deviceLoss.ts ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _babylonjs_core__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babylonjs_core__WEBPACK_IMPORTED_MODULE_2__);
 // JS-side scaffolding for Tests.ExternalTexture.DeviceLoss.cpp.
//
...
function startup(outputNativeTexture, width, height) {
  ...
  scene.clearColor = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Color4(1, 1, 1, 1);

  var camera = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.FreeCamera("camera", new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Vector3(0, 0, -3), scene);
  ...
  plane = _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.MeshBuilder.CreatePlane("plane", { size: 1.8 }, scene);
  mat = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.StandardMaterial("mat", scene);
  mat.emissiveColor = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Color3(1, 0, 0);
  ...
  rtt.clearColor = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Color4(1, 1, 1, 1);
  rtt.activeCamera = camera;
  rtt.renderList.push(plane);
}function

renderFrame() {return _renderFrame.apply(this, arguments);}function _renderFrame() {_renderFrame = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {while (1) switch (_context.prev = _context.next) {case 0:_context.next = 1;return (
            scene.whenReadyAsync());case 1:
          rtt.render();case 2:case "end":return _context.stop();}}, _callee);}));return _renderFrame.apply(this, arguments);}


function restoreTexture(newNativeTexture) {
  if (typeof engine.updateWrappedNativeTexture !== "function") {
    throw new Error("updateWrappedNativeTexture not available -- requires @babylonjs/core >= 9.9.1");
  }
  var wrappedInternalTexture = rtt.renderTarget.texture;
  ...
  mat.emissiveColor = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.Color3(0, 0, 1);
}

globalThis.startup = startup;
globalThis.renderFrame = renderFrame;
globalThis.restoreTexture = restoreTexture;
})();
