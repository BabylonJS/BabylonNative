...
function startup(outputNativeTexture, width, height, samples) {
  ...
  var plane = _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.MeshBuilder.CreatePlane("rotated", { size: 1.4 }, scene);
  plane.rotation.z = Math.PI / 7;
  var mat = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_2__.StandardMaterial("redMat", scene);
