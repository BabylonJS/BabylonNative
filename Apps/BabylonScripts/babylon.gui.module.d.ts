...
declare module "babylonjs-gui/3D/gizmos/boundingBoxGizmo2D" {
    ...
    export class BoundingBoxGizmo2D extends Gizmo {
        ...
        private _createNode;
        private _moveTLCorner;
        private _moveBLCorner;
        private _moveBRCorner;
        private _moveTRCorner;
...
declare module "babylonjs-gui/3D/gizmos/index" {
    export * from "babylonjs-gui/3D/gizmos/boundingBoxGizmo2D";
}
...
declare module BABYLON.GUI {
     ...
     */
    export class BoundingBoxGizmo2D extends BABYLON.Gizmo {
        private _boundingDimensions;
        private _dragPlaneNormal;
        /**
         * Relative bounding box pivot used when scaling the attached node. When null object with scale from the opposite corner. 0.5,0.5,0.5 for center and 0.5,0,0.5 for bottom (Default: null)
         */
        scalePivot: BABYLON.Nullable<BABYLON.Vector3>;
        private _tmpQuaternion;
        private _tmpVector;
        private _corners;
        private _cornersParent;
        ...
        /**
         * Updates the bounding box information for the BABYLON.Gizmo
         */
        updateBoundingBox(): void;
    }
}