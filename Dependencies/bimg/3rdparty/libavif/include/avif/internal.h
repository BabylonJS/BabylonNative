...
// Returns AVIF_TRUE if x does not fit in a signed 32-bit integer.
// Defined here (rather than in multiple .c files) so the sources can be
// amalgamated into a single translation unit.
static inline avifBool overflowsInt32(int64_t x)
{
