...
ChakraRuntime::ChakraRuntime(void* runtime, void* context) noexcept {
  m_runtime = reinterpret_cast<JsRuntimeHandle*>(runtime);
  m_context.Initialize(reinterpret_cast<JsContextRef>(context));
