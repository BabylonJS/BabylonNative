...
namespace Babylon::Graphics
{
    ...
    {
    public:
        using CancellationSourceGetter = std::function<std::shared_ptr<arcana::cancellation_source>()>;
        explicit SafeTimespanGuarantor(CancellationSourceGetter getCancellationSource);
    ...
    private:
        std::shared_ptr<arcana::cancellation_source> TryGetCancellationSource() const;
        ...
        CancellationSourceGetter m_getCancellationSource;
