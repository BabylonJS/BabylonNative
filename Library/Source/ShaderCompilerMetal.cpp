...
namespace glslang
{
    ...
    std::unique_ptr<spirv_cross::Compiler> CompileShader(glslang::TProgram& program,
                                                         EShLanguage stage,
...
namespace babylon
{
                                 ...
                                 std::function<void(ShaderInfo, ShaderInfo)> onCompiled)
    {
        ...
        onCompiled({std::move(vertexCompiler), gsl::make_span(strVertex, vertexShaderMSL.size())},
