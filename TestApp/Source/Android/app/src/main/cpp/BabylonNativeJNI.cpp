...
extern "C"
{
    JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_initEngine(JNIEnv* env,
                                                                                        jobject obj,
                                                                                        jobject assetMgr,
                                                                                        jstring path);
    JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_finishEngine(JNIEnv* env, jobject obj);
    JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_surfaceCreated(JNIEnv* env,
                                                                                            jobject obj,
                                                                                            jobject surface);
    JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_surfaceChanged(JNIEnv* env,
                                                                                            jobject obj,
                                                                                            jint width,
                                                                                            jint height);
    JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_openFile(JNIEnv* env,
                                                                                      jobject obj,
                                                                                      jstring path);
    JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_openStream(JNIEnv* env,
                                                                                        jobject obj,
                                                                                        jobjectArray input);
    JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_setTouchInfo(
        JNIEnv* env, jobject obj, jfloat dx, jfloat dy, jboolean down);
    JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_setPinchInfo(JNIEnv* env,
                                                                                          jobject obj,
                                                                                          jfloat zoom);
...
namespace babylon
{
    ...
    std::vector<char> GetFileContents(const std::string& file_name)
    {
        ...
        AAsset* asset = AAssetManager_open(g_assetMgrNative, file_name.c_str(), AASSET_MODE_UNKNOWN);
...
JNIEXPORT void JNICALL Java_com_android_appviewer_AndroidViewAppActivity_setTouchInfo(
    JNIEnv* env, jobject obj, jfloat x, jfloat y, jboolean down)
{
